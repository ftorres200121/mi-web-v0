      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Estamos listos para ayudarte con tus necesidades tecnológicas. Contáctanos para una consulta personalizada.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      José Vivanco N44-198 y Av. El Inca
                      <br />
                      Quito, Ecuador
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+(593) 2 601 9628</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Ventas: ventas@megacore.com.ec
                      <br />
                      Soporte: contacto@megacore.com.ec
                    </p>
                  </div>
                </div>
